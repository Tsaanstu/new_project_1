...
Quiz_mr::Quiz_mr() {
    ...
    dragon_image.loadFromFile("images/mermaid1.png");
    ...
    background_image.loadFromFile("images/merm_back.png");
    ...
    music.openFromFile("sounds/UtS.ogg");
    music.setVolume(100);
    music.setLoop(true);
}

void Quiz_mr::dragon_move() {
    current_frame++;
    if (current_frame > 5) {
        current_frame = 0;
    }
...
void Quiz_mr::game_show(sf::RenderWindow &window, int &hp, int &score) {
    int user_answer = 0;
